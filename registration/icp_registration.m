function [warped_image,num_of_Corres,transf_Matrices,thresh3]=icp_registration(new_image,edge_atlas,atlasorientation,flag,edgepath,Num)
...
% removing outliers
[A1,bx1,by1] = outlierRemoval(I,Inew,edge_atlas,atlasorientation,A,bx,by,false,Num);
