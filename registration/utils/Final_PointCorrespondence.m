function [A,bx,by]=Final_PointCorrespondence(imageorientation,atlasorientation)
...
[i,j]=ind2sub(size(imageorientation),totalIterations(tIter));
        ...
        filter_values1 = actual_values(distance_image <= 100);                 % 
        ...
        if(length(filter_values1) >= 1)
            ...
            filter_values2 = filter_values1(angle_diff < 1);                    % angle deviation of 1 degree
